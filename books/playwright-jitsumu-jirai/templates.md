...
AI 業務自動化と、AI を使った就活サポートを個人で作っています。

- ブログ（AI 動向の毎日まとめ）：https://ai-hack-lab.com/
- AI を仕事に使うショート動画：YouTube「ピクトAI」
- 就活 ES / ビジネス文章を AI で書くプロンプト集：[ココナラ](https://coconala.com/users/pikuto)
- note のミニ版（各 ¥300）：[志望動機](https://note.com/witty_bobcat6938/n/n46e2d64812ee) / [ガクチカ](https://note.com/witty_bobcat6938/n/nb6c8db580391) / [社長向けメール AI](https://note.com/witty_bobcat6938/n/n27e8b4fa9d01)

「自分が困ったから作った」型の制作物だけを並べています。この本の内容が役に立ったら、覗いてみてください。
